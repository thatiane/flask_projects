...
delete_all_seen_messages_admin = Blueprint('delete_all_seen_messages_admin', __name__)

# delete all seen messages

@delete_all_seen_messages_admin.route('/admin/delete_all_seen_messages', methods=['post', 'get'])
@is_admin_logged_in
