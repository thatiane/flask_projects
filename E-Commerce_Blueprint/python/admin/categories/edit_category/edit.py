...
edit_category_admin = Blueprint('edit_category_admin', __name__)
...
@edit_category_admin.route('/admin/edit_category/<current_category>', methods=['post', 'get'])
@is_admin_logged_in
def edit_category(current_category):
    ...
    return render_template('admin_edit_category.html', form=form, admin_name=session['admin_username'],
                           admin_image=session['admin_image'], permission=session['permission'], messages=messages,
