...
edit_slider_admin = Blueprint('edit_slider_admin', __name__)
...
@edit_slider_admin.route('/admin/edit_product_slider/<id>', methods=['post', 'get'])
@is_admin_logged_in
def edit_product_slider(id):
    ...
    if request.method == 'POST' and form.validate():
        ...
        if file and allowed_file(file.filename):
            ...
            os.rename(
                os.path.join(app.root_path + r"\static\uploads\slider_products\{}".format(product['product_name'])),
