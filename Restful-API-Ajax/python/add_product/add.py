    ...
    if request.method == 'POST':
        ...
        #     file.save(os.path.join(dir, filename))
            ...
            if discount != '' and discount != ' ':
                ...
                number_of_sales = res['number_of_sales']
                number_of_views = res['number_of_views']
                ...
                return jsonify({'success': 'True added successfully with discount',
                                'id': id, 'category': category, 'number_of_sales': number_of_sales,
                                'number_of_views': number_of_views, 'product_name': product_name,
                                'description': description, 'price': price, 'discount': discount,
                                'quantity': quantity, 'files': files, 'create_date': create_date})
